...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btArrowScroll', [
    '$window',
    function ($window) {
      return {
        restrict: 'A',
...
}(angular.module('BestFitApp')));
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btAutoSubmit', [
    '$timeout',
    function ($timeout) {
      return {
        require: 'form',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btCenterOnPage', [
    '$window',
    '$timeout',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btDropdown', [
    '$window',
    function ($window) {
      return {
        restrict: 'A',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btErrorImg', function () {
    return {
      link: function (scope, element, attrs) {
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btFocusOn', [
    '$timeout',
    function ($timeout) {
      return {
        restrict: 'A',
...
(function (BestFitApp) {
  BestFitApp.directive('btFormatMoney', [
    '$filter',
    function ($filter) {
      return {
        restrict: 'A',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btIFrame', function ($window) {
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btInfiniteScrollElement', [
    '$rootScope',
    '$timeout',
    function ($rootScope, $timeout) {
      return {
        link: function (scope, elem, attrs) {
          ...
          // if (attrs.infiniteScrollDisabled || attrs.infiniteScrollDisabled === false) {
...
(function (BestFitApp) {
   ...
   */
  BestFitApp.directive('btLockBody', [
    '$document',
    '$window',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btNgModelOnblur', [
    '$analytics',
    function ($analytics) {
      return {
        restrict: 'A',
...
(function (BestFitApp) {
  'use strict';
  BestFitApp.directive('btNumber', function () {
    return {
      require: 'ngModel',
      restrict: 'A',
    ...
    '$window',
    '$timeout',
    function ($analytics, $window, $timeout) {
