...
})},currentStep:-1,isHidden:!1,shouldResume:function(val){return angular.isDefined(val)&&(tour.isHidden=val,tour.onNextStep&&tour.onNextStep()),tour.isHidden},goToNextStep:function(){tourRef.next()},endTour:function(){tourRef.end()}};return tour})}(angular.module("boomstrap"),window.Tour);